...
var aircraftWeightsCirrusSR20 = [
    ...
    new AircraftWeight(5, 'Max Payload', 385, payloadDescription),
];
...
export var aircraftList = [
        new Aircraft(1, "Cessna 172", aircraftSpeedsCessna172, aircraftWeightsCessna172, "/res/Cessna172.jpg"),
        new Aircraft(2, "Cirrus SR20", aircraftSpeedsCirrusSR20, aircraftWeightsCirrusSR20, "/res/CirrusSR20.jpg"),
        new Aircraft(3, "Piper PA28", aircraftSpeedsPA28, aircraftWeightsPA28, "/res/PA28.jpg")
    ];
